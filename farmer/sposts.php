...
$sql = "SELECT postid, scid, problem, pdescr, image, fid, status, reqans, ctype FROM posttl where scid='$login_session' and status='Pending' ";
...
if ($count > 0) {
    while ($row = $rs->fetch_assoc()) {
        ...
        <tr>
        	...
        	<td>
        		<textarea rows="5" cols="30" name="reqans"></textarea>
        	</td>
        	<td><input type="hidden" value='<?php echo  $postid;?>' name='pid'>
