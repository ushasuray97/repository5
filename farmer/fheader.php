...
<div class="address"><i class="fa fa-home floatleft"></i>
<p>Sai Nagar 2nd Cross, Ananthapuramu</p>
</div>
</div>
<!--End of col-md-4-->
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 zero_mp">
...
<!--End of col-md-4-->
<div class="col-md-4">
<div class="social_icon text-right"><a href="#"><i
...
<div class="container"><nav class="navbar navbar-default zero_mp "> <!-- Brand and toggle get grouped for better mobile display -->
...
<ul class="nav navbar-nav navbar-right main_menu">
	<li><a href="fhome.php">Home <span class="sr-only">(current)</span></a></li>
	<li><a href="fposts.php">My Queries</a></li>
	<li><a href="addpost.php">Ask New Query</a></li>

	<li><a href="logout.php">logout</a></li>
</ul>
</div>
<!-- /.navbar-collapse --> </nav> <!--End of nav--></div>
<!--End of container--></div>
<!--End of header menu--></div>
<!--end of header area-->
</section>
